Public Class cConnections
    ...
    Public Function MainConnection() As String
        Dim gstrConnStr As String = "Data Source=tcp:sql2k802.discountasp.net;Initial Catalog=SQL2008_786647_crdata;Persist Security Info=True;User ID=xxxx;Password=yyyy"
